...
This folder stores reusable Microsoft Fabric notebook templates that
consume approved metadata and contracts.
...
Use metadata-driven parameters so notebook behavior stays consistent
across domains.
