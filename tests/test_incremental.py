...
def test_no_pyspark_import_at_module_import_time() -> None:
    sys.modules.pop("fabric_data_product_framework.incremental", None)
    before = set(sys.modules)
    importlib.import_module("fabric_data_product_framework.incremental")
    assert "pyspark" not in (set(sys.modules) - before)


def test_spark_path_code_exists_without_topandas_usage() -> None:
    import fabric_data_product_framework.incremental as incremental
