...
SYMBOL_WORKFLOW_STEP = {
    ...
    "scan_notebook_lineage": 13,
    "scan_notebook_cells": 13,
    "enrich_lineage_steps_with_ai": 13,
    "fallback_copilot_lineage_prompt": 13,
    "validate_lineage_steps": 13,
    "build_lineage_record_from_steps": 13,
    "build_lineage_from_notebook_code": 13,
    "build_lineage_handover_markdown": 13,
    "plot_lineage_steps": 13,
