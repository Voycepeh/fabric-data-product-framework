...
|---|---|---|---|
| [`standardize_output_columns`](../../api/reference/standardize_output_columns/) | function | Apply canonical technical/audit enrichment in one notebook-facing wrapper. | — |
