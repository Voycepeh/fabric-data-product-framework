...
|---|---|---|---|
| [`build_dataset_run_record`](../../reference/step-07-output-validation-target-metadata/build_dataset_run_record.md) | function | Build a dataset run metadata record for audit and handover. | — |
| [`build_quality_result_records`](../../reference/step-07-output-validation-target-metadata/build_quality_result_records.md) | function | Convert quality rule results into metadata records. | — |
