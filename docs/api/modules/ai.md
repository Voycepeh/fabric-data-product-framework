...
|---|---|---|---|
| [`build_dq_rule_candidate_prompt`](../../reference/step-05-source-profiling-metadata/build_dq_rule_candidate_prompt.md) | function | Build standardized prompt text for AI-assisted DQ candidate generation. | — |
