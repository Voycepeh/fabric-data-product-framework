...
| [`build_dq_rule_deactivation_metadata_df`](../../reference/build_dq_rule_deactivation_metadata_df/) | function | — | [`_resolve_action_by`](../../reference/internal/data_quality/_resolve_action_by/) (internal) |
| [`build_dq_rules_metadata_df`](../../reference/build_dq_rules_metadata_df/) | function | Build approved DQ metadata rows as a Spark DataFrame. | [`_resolve_action_by`](../../reference/internal/data_quality/_resolve_action_by/) (internal) |
| [`extract_candidate_rules_from_responses`](../../reference/extract_candidate_rules_from_responses/) | function | Extract candidate DQ rules from Spark/list AI responses. | [`_extract_dq_rules`](../../reference/internal/data_quality/_extract_dq_rules/) (internal), [`_parse_dq_rules_dict_from_text`](../../reference/internal/data_quality/_parse_dq_rules_dict_from_text/) (internal) |
...
| [`_extract_dq_rules`](../../reference/internal/data_quality/_extract_dq_rules/) | [`draft_dq_rules`](../../reference/draft_dq_rules/), [`extract_candidate_rules_from_responses`](../../reference/extract_candidate_rules_from_responses/) |
...
| [`_load_active_dq_rules`](../../reference/internal/data_quality/_load_active_dq_rules/) | [`enforce_dq_rules`](../../reference/enforce_dq_rules/), [`load_approved_dq_rules`](../../reference/load_approved_dq_rules/) |
| [`_parse_dq_rules_dict_from_text`](../../reference/internal/data_quality/_parse_dq_rules_dict_from_text/) | [`extract_candidate_rules_from_responses`](../../reference/extract_candidate_rules_from_responses/) |
...
| [`_resolve_action_by`](../../reference/internal/data_quality/_resolve_action_by/) | [`build_dq_rule_deactivation_metadata_df`](../../reference/build_dq_rule_deactivation_metadata_df/), [`build_dq_rules_metadata_df`](../../reference/build_dq_rules_metadata_df/) |
| [`_run_dq_rules`](../../reference/internal/data_quality/_run_dq_rules/) | [`enforce_dq_rules`](../../reference/enforce_dq_rules/) |
| [`_split_dq_rows`](../../reference/internal/data_quality/_split_dq_rows/) | [`enforce_dq_rules`](../../reference/enforce_dq_rules/) |
