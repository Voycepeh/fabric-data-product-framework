...
| Callable | Type | Summary | Related helpers |
|---|---|---|---|
| [`build_contract_column_records`](../../reference/step-07-output-profile-product-contract/build_contract_column_records.md) | function | Build normalized contract-column metadata records for persistence. | [`_now_utc_iso`](../../reference/internal/contracts/_now_utc_iso.md) (internal) |
...
| [`build_contract_rule_records`](../../reference/step-07-output-profile-product-contract/build_contract_rule_records.md) | function | Build quality-rule metadata records from a validated contract. | [`_now_utc_iso`](../../reference/internal/contracts/_now_utc_iso.md) (internal) |
