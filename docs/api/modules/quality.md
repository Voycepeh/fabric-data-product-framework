...
|---|---|---|---|
| [`load_data_contract`](../../reference/step-03-source-contract-ingestion/load_data_contract.md) | function | Execute the `load_data_contract` workflow step in FabricOps. | — |
