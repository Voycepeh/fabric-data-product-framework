...
|---|---|---|---|
| [`load_data_contract`](../../reference/step-03-source-contract-ingestion/load_data_contract.md) | function | Load and normalize a data product contract from file path or dictionary. | — |
