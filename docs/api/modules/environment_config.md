...
|---|---|---|---|
| [`bootstrap_fabric_env`](../../reference/step-02b-notebook-startup-checks/bootstrap_fabric_env.md) | function | Bootstrap 00_env_config environment readiness for FabricOps notebooks. | [`_get_fabric_runtime_metadata`](../../reference/internal/environment_config/_get_fabric_runtime_metadata.md) (internal) |
...
| [`run_config_smoke_tests`](../../reference/step-02b-notebook-startup-checks/run_config_smoke_tests.md) | function | Run 00_env_config readiness smoke checks for configuration bootstrap. | [`_check_spark_session`](../../reference/internal/environment_config/_check_spark_session.md) (internal), [`_get_fabric_runtime_metadata`](../../reference/internal/environment_config/_get_fabric_runtime_metadata.md) (internal) |
...
|---|---|
| [`_check_spark_session`](../../reference/internal/environment_config/_check_spark_session.md) | [`run_config_smoke_tests`](../../reference/step-02b-notebook-startup-checks/run_config_smoke_tests.md) |
| [`_default_schema_text`](../../reference/internal/environment_config/_default_schema_text.md) | — |
| [`_format_error_path`](../../reference/internal/environment_config/_format_error_path.md) | — |
| [`_get_fabric_runtime_metadata`](../../reference/internal/environment_config/_get_fabric_runtime_metadata.md) | [`bootstrap_fabric_env`](../../reference/step-02b-notebook-startup-checks/bootstrap_fabric_env.md), [`run_config_smoke_tests`](../../reference/step-02b-notebook-startup-checks/run_config_smoke_tests.md) |
| [`_load_schema`](../../reference/internal/environment_config/_load_schema.md) | — |
