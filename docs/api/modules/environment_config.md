...
| Callable | Type | Summary | Related helpers |
|---|---|---|---|
| [`check_fabric_ai_functions_available`](../../reference/step-02b-notebook-startup-checks/check_fabric_ai_functions_available.md) | function | Check whether Fabric AI Functions are available in the current runtime. | — |
