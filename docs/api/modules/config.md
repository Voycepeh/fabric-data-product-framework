...
| [`create_framework_config`](../../reference/step-02a-shared-runtime-config/create_framework_config.md) | function | Create the top-level framework configuration object. | — |
| [`create_governance_config`](../../reference/step-02a-shared-runtime-config/create_governance_config.md) | function | Create governance-default configuration. | — |
| [`create_lineage_config`](../../reference/step-02a-shared-runtime-config/create_lineage_config.md) | function | Create lineage-default configuration. | — |
...
| [`create_quality_config`](../../reference/step-02a-shared-runtime-config/create_quality_config.md) | function | Create quality-default configuration. | — |
...
| [`validate_framework_config`](../../reference/step-02a-shared-runtime-config/validate_framework_config.md) | function | Validate and normalize framework config input. | — |
