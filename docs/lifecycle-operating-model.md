...
![FabricOps Starter Kit canonical lifecycle workflow]([docs/assets/mvp-flow.png](https://github.com/Voycepeh/FabricOps-Starter-Kit/blob/main/docs/assets/mvp-flow.png))
