...
Quick local smoke test of profiling, quality checks, governance
classification input shaping, drift checks, and lineage record generation
without Fabric-only dependencies.
