...
Execute the data product from a contract using `run_data_product`
with explicit contract validation and gate assertion.
...
See [src/README.md](../../src/README.md) section:
Contract-first orchestration and contract models.
