...
Run a Fabric-native dry run for Lakehouse read/write, profiling,
contract-driven DQ workflow, and governance outputs.
...
See [src/README.md](../../src/README.md) sections: Fabric notebook runtime,
Profiling, Data quality workflow, and Governance classification.
