...
- **GitHub Pages docs:** detailed operating manual, runbooks, architecture/lifecycle detail, and generated function reference.
...
The function reference under `docs/reference/` is generated by mkdocstrings and is best viewed through the published docs site.
...
See [generated function reference](docs/reference/index.md).
