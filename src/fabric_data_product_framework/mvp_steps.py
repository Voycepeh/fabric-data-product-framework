...
MVP_STEP_REGISTRY: list[dict[str, Any]] = [
    {
        ...
        "canonical_modules": ["runtime.py", "fabric.py"],
    ...
    },
    {
        ...
        "owner_type": "human",
        "canonical_modules": ["fabric.py", "config.py"],
    ...
    },
    {
        ...
        "owner_type": "mixed",
        "canonical_modules": ["fabric.py", "contracts.py"],
    ...
    },
    {
        ...
        "owner_type": "framework",
        "canonical_modules": ["fabric.py", "technical_columns.py"],
    ...
    },
    {
        ...
        "owner_type": "framework",
        "canonical_modules": ["fabric.py", "profiling.py", "metadata.py"],
