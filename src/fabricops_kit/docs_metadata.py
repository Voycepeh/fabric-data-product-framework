...
PUBLIC_SYMBOL_DOCS: list[PublicSymbolDocMetadata] = [
    {"symbol_name": "Housepath", "module": "fabric_io", "kind": "class", "workflow_step": "2A", "summary_override": None},
    ...
    {"symbol_name": "lakehouse_table_write", "module": "fabric_io", "kind": "function", "workflow_step": "6D", "summary_override": None},
    ...
    {"symbol_name": "warehouse_write", "module": "fabric_io", "kind": "function", "workflow_step": "6D", "summary_override": None},
    {"symbol_name": "seed_minimal_sample_source_table", "module": "fabric_io", "kind": "function", "workflow_step": 4, "importance": "Optional", "summary_override": "Create and persist deterministic demo rows into a sample source table."},
    
    {"symbol_name": "generate_run_id", "module": "runtime", "kind": "function", "workflow_step": 1, "summary_override": None},
    {"symbol_name": "build_runtime", "module": "runtime", "kind": "function", "workflow_step": 1, "summary_override": None},
    ...
    {"symbol_name": "build_governance_candidate_prompt", "module": "governance", "kind": "function", "workflow_step": 9, "summary_override": None},
    {"symbol_name": "build_handover_summary_prompt", "module": "run_summary", "kind": "function", "workflow_step": 10, "summary_override": None},
    {"symbol_name": "build_manual_dq_rule_prompt_package", "module": "data_quality", "kind": "function", "workflow_step": 8, "summary_override": None},
    {"symbol_name": "build_manual_governance_prompt_package", "module": "governance", "kind": "function", "workflow_step": 9, "summary_override": None},
    {"symbol_name": "build_manual_handover_prompt_package", "module": "run_summary", "kind": "function", "workflow_step": 10, "summary_override": None},
    {"symbol_name": "parse_manual_ai_json_response", "module": "run_summary", "kind": "function", "workflow_step": 10, "summary_override": None},
    ...
    {"symbol_name": "generate_governance_candidates_with_fabric_ai", "module": "governance", "kind": "function", "workflow_step": 9, "summary_override": None},
    {"symbol_name": "generate_handover_summary_with_fabric_ai", "module": "run_summary", "kind": "function", "workflow_step": 10, "summary_override": None},
    ...
    {"symbol_name": "load_data_contract", "module": "contracts", "kind": "function", "workflow_step": 3, "summary_override": None},
    ...
    {"symbol_name": "normalize_contract_dict", "module": "contracts", "kind": "function", "workflow_step": 3, "summary_override": None},
    {"symbol_name": "validate_contract_dict", "module": "contracts", "kind": "function", "workflow_step": 3, "summary_override": None},
    {"symbol_name": "build_contract_header_record", "module": "contracts", "kind": "function", "workflow_step": 7, "summary_override": None},
    {"symbol_name": "build_contract_column_records", "module": "contracts", "kind": "function", "workflow_step": 7, "summary_override": "Build normalized contract-column metadata records for persistence."},
    {"symbol_name": "build_contract_rule_records", "module": "contracts", "kind": "function", "workflow_step": 7, "summary_override": "Build quality-rule metadata records from a validated contract."},
    {"symbol_name": "build_contract_records", "module": "contracts", "kind": "function", "workflow_step": 7, "summary_override": "Build grouped contract header, column, and rule metadata payloads."},
    {"symbol_name": "contract_records_to_spark", "module": "contracts", "kind": "function", "workflow_step": 7, "summary_override": None},
    {"symbol_name": "write_contract_to_lakehouse", "module": "contracts", "kind": "function", "workflow_step": 7, "summary_override": "Validate and persist contract records into Fabric metadata tables."},
    {"symbol_name": "load_contract_from_lakehouse", "module": "contracts", "kind": "function", "workflow_step": 3, "summary_override": "Load one contract by ID/version from Fabric metadata storage."},
    {"symbol_name": "load_latest_approved_contract", "module": "contracts", "kind": "function", "workflow_step": 3, "summary_override": "Load the latest approved contract for a dataset/object pair."},
    {"symbol_name": "extract_required_columns", "module": "contracts", "kind": "function", "workflow_step": 3, "summary_override": "Extract required column names from a normalized contract."},
    {"symbol_name": "extract_optional_columns", "module": "contracts", "kind": "function", "workflow_step": 3, "summary_override": "Extract optional column names from a normalized contract."},
    {"symbol_name": "extract_business_keys", "module": "contracts", "kind": "function", "workflow_step": 3, "summary_override": "Extract business-key column names from a normalized contract."},
    {"symbol_name": "extract_classifications", "module": "contracts", "kind": "function", "workflow_step": 3, "summary_override": "Extract column classification mappings from a normalized contract."},
    {"symbol_name": "extract_quality_rules", "module": "contracts", "kind": "function", "workflow_step": 3, "summary_override": "Extract raw quality-rule definitions from a normalized contract."},
    {"symbol_name": "get_executable_quality_rules", "module": "contracts", "kind": "function", "workflow_step": "6C", "summary_override": "Return normalized quality rules ready for pipeline enforcement."},
    {"symbol_name": "build_contract_summary", "module": "contracts", "kind": "function", "workflow_step": 7, "summary_override": "Build a concise contract summary for reviews and handover."},

    {"symbol_name": "AI_SUGGESTABLE_DQ_RULE_TYPES", "module": "dq", "kind": "constant", "workflow_step": 8, "importance": "Essential", "summary_override": None},
    {"symbol_name": "profile_for_dq", "module": "dq", "kind": "function", "workflow_step": 8, "summary_override": None},
    {"symbol_name": "suggest_dq_rules", "module": "dq", "kind": "function", "workflow_step": 8, "summary_override": None},
    {"symbol_name": "review_dq_rules", "module": "dq_review", "kind": "function", "workflow_step": 8, "summary_override": None},
    {"symbol_name": "extract_dq_rules", "module": "dq", "kind": "function", "workflow_step": 8, "summary_override": None},
    {"symbol_name": "load_active_dq_rules", "module": "dq", "kind": "function", "workflow_step": 8, "summary_override": None},
    {"symbol_name": "split_dq_rows", "module": "dq", "kind": "function", "workflow_step": 8, "summary_override": None},
    {"symbol_name": "build_dq_rule_history", "module": "dq", "kind": "function", "workflow_step": 8, "summary_override": None},
    {"symbol_name": "build_dq_rule_deactivations", "module": "dq", "kind": "function", "workflow_step": 8, "summary_override": None},
    {"symbol_name": "review_dq_rule_deactivations", "module": "dq", "kind": "function", "workflow_step": 8, "summary_override": None},
