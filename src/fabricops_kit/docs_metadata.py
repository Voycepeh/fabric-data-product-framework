...
MODULE_DOCS_METADATA: list[ModuleDocMetadata] = [
    ...
    {"module_name": "data_product_metadata", "visibility": "internal", "module_summary": "Metadata-backed agreement selection and notebook traceability helpers.", "sidebar_group": "Advanced", "sidebar_include": False},
