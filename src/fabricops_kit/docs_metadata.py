...
PUBLIC_SYMBOL_DOCS: list[PublicSymbolDocMetadata] = [
    ...
    {"symbol_name": "validate_framework_config", "module": "config", "kind": "function", "workflow_step": "2A", "role": "essential", "summary_override": None},
    {"symbol_name": "bootstrap_fabric_env", "module": "config", "kind": "function", "workflow_step": "2B", "role": "essential", "summary_override": None},
    {"symbol_name": "run_config_smoke_tests", "module": "config", "kind": "function", "workflow_step": "2B", "role": "essential", "summary_override": None},
    {"symbol_name": "check_fabric_ai_functions_available", "module": "config", "kind": "function", "workflow_step": "2B", "role": "optional", "summary_override": None},
    ...
    {"symbol_name": "enrich_lineage_steps_with_ai", "module": "data_lineage", "kind": "function", "workflow_step": 10, "role": "internal", "summary_override": None},
    {"symbol_name": "fallback_copilot_lineage_prompt", "module": "data_lineage", "kind": "function", "workflow_step": 10, "role": "internal", "summary_override": None},
    {"symbol_name": "validate_lineage_steps", "module": "data_lineage", "kind": "function", "workflow_step": 10, "summary_override": None},
    {"symbol_name": "build_lineage_record_from_steps", "module": "data_lineage", "kind": "function", "workflow_step": 10, "role": "internal", "summary_override": None},
    ...
    {"symbol_name": "build_contract_header_record", "module": "data_contracts", "kind": "function", "workflow_step": 7, "role": "internal", "summary_override": None},
    {"symbol_name": "build_contract_column_records", "module": "data_contracts", "kind": "function", "workflow_step": 7, "role": "internal", "summary_override": "Build normalized contract-column metadata records for persistence."},
    {"symbol_name": "build_contract_rule_records", "module": "data_contracts", "kind": "function", "workflow_step": 7, "role": "internal", "summary_override": "Build quality-rule metadata records from a validated contract."},
    {"symbol_name": "build_contract_records", "module": "data_contracts", "kind": "function", "workflow_step": 7, "role": "internal", "summary_override": "Build grouped contract header, column, and rule metadata payloads."},
    {"symbol_name": "contract_records_to_spark", "module": "data_contracts", "kind": "function", "workflow_step": 7, "role": "internal", "summary_override": None},
