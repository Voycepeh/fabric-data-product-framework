...
PUBLIC_SYMBOL_DOCS: list[PublicSymbolDocMetadata] = [{'symbol_name': 'Housepath',
 ...
 {'symbol_name': 'classify_columns',
  ...
  'template_notebook': '03_pc',
  'template_segment': 'Optional profiling, drift, governance, lineage, and handover'},
 {'symbol_name': 'build_governance_classification_records',
  'module': 'data_governance',
  'kind': 'function',
  'workflow_step': 9,
  'role': 'essential',
  ...
  'template_notebook': '03_pc',
  'template_segment': 'Optional profiling, drift, governance, lineage, and handover'},
 {'symbol_name': 'write_governance_classifications',
  'module': 'data_governance',
  'kind': 'function',
  'workflow_step': 9,
  'role': 'essential',
  ...
  'template_notebook': '03_pc',
  'template_segment': 'Optional profiling, drift, governance, lineage, and handover'},
 {'symbol_name': 'summarize_governance_classifications',
  'module': 'data_governance',
  'kind': 'function',
  'workflow_step': 9,
  'role': 'essential',
 ...
 {'symbol_name': 'standardize_output_columns',
  ...
  'template_notebook': '03_pc',
  'template_segment': 'Segment 3: Transform and apply runtime standards'},
 {'symbol_name': 'build_dq_rules_metadata_df', 'module': 'data_quality', 'kind': 'function', 'workflow_step': '8', 'role': 'optional', 'summary_override': None, 'template_notebook': '02_ex', 'template_segment': 'Not mapped in template flow segment'},
 {'symbol_name': 'build_dq_rule_deactivation_metadata_df', 'module': 'data_quality', 'kind': 'function', 'workflow_step': '8', 'role': 'optional', 'summary_override': None, 'template_notebook': '02_ex', 'template_segment': 'Not mapped in template flow segment'},
 {'symbol_name': 'suggest_dq_rules_with_fabric_ai', 'module': 'data_quality', 'kind': 'function', 'workflow_step': '8', 'role': 'optional', 'summary_override': None, 'template_notebook': '02_ex', 'template_segment': 'Not mapped in template flow segment'},
 {'symbol_name': 'extract_candidate_rules_from_responses', 'module': 'data_quality', 'kind': 'function', 'workflow_step': '8', 'role': 'optional', 'summary_override': None, 'template_notebook': '02_ex', 'template_segment': 'Not mapped in template flow segment'},
 {'symbol_name': 'attach_rule_metadata_keys', 'module': 'data_quality', 'kind': 'function', 'workflow_step': '8', 'role': 'optional', 'summary_override': None, 'template_notebook': '02_ex', 'template_segment': 'Not mapped in template flow segment'},
 {'symbol_name': 'build_dq_review_rows', 'module': 'data_quality', 'kind': 'function', 'workflow_step': '8', 'role': 'optional', 'summary_override': None, 'template_notebook': '02_ex', 'template_segment': 'Not mapped in template flow segment'},
 {'symbol_name': 'prepare_governance_profile_input', 'module': 'data_governance', 'kind': 'function', 'workflow_step': '9', 'role': 'optional', 'summary_override': None, 'template_notebook': '03_pc', 'template_segment': 'Not mapped in template flow segment'},
 {'symbol_name': 'suggest_personal_identifier_classifications', 'module': 'data_governance', 'kind': 'function', 'workflow_step': '9', 'role': 'optional', 'summary_override': None, 'template_notebook': '03_pc', 'template_segment': 'Not mapped in template flow segment'},
 {'symbol_name': 'extract_personal_identifier_suggestions', 'module': 'data_governance', 'kind': 'function', 'workflow_step': '9', 'role': 'optional', 'summary_override': None, 'template_notebook': '03_pc', 'template_segment': 'Not mapped in template flow segment'},
 {'symbol_name': 'review_column_governance_context', 'module': 'data_governance', 'kind': 'function', 'workflow_step': '9', 'role': 'optional', 'summary_override': None, 'template_notebook': '03_pc', 'template_segment': 'Not mapped in template flow segment'},
{'symbol_name': 'run_governance_widget', 'module': 'data_governance', 'kind': 'function', 'workflow_step': '9', 'role': 'essential', 'summary_override': 'Run governance review with AI-advisory suggestions and optional metadata persistence.', 'template_notebook': '03_pc', 'template_segment': 'Optional profiling, drift, governance, lineage, and handover'},
{'symbol_name': 'get_governance_widget_results', 'module': 'data_governance', 'kind': 'function', 'workflow_step': '9', 'role': 'essential', 'summary_override': 'Collect governance widget approvals/rejections with agreement metadata.', 'template_notebook': '01_data_agreement', 'template_segment': 'Not mapped in template flow segment'},
{'symbol_name': 'save_governance_widget_results', 'module': 'data_governance', 'kind': 'function', 'workflow_step': '9', 'role': 'essential', 'summary_override': 'Persist approved governance widget results to metadata.', 'template_notebook': '01_data_agreement', 'template_segment': 'Not mapped in template flow segment'},
{'symbol_name': 'load_governance_context', 'module': 'data_governance', 'kind': 'function', 'workflow_step': '9', 'role': 'essential', 'summary_override': 'Load approved governance metadata as read-only agreement context for downstream notebooks.', 'template_notebook': '03_pc', 'template_segment': 'Segment 1: Load shared config and runtime context'},
 {'symbol_name': 'COLUMN_GOVERNANCE_CONTEXT_FROM_WIDGET', 'module': 'data_governance', 'kind': 'constant', 'workflow_step': '9', 'role': 'optional', 'summary_override': 'Approved governance context rows captured during review.', 'template_notebook': '03_pc', 'template_segment': 'Not mapped in template flow segment'},
 {'symbol_name': 'REJECTED_COLUMN_GOVERNANCE_CONTEXT_FROM_WIDGET', 'module': 'data_governance', 'kind': 'constant', 'workflow_step': '9', 'role': 'optional', 'summary_override': 'Rejected governance context rows captured during review.', 'template_notebook': '03_pc', 'template_segment': 'Not mapped in template flow segment'},
 {'symbol_name': 'COLUMN_BUSINESS_CONTEXT_FROM_WIDGET', 'module': 'business_context', 'kind': 'constant', 'workflow_step': '9', 'role': 'optional', 'summary_override': 'Approved business context rows captured during review.', 'template_notebook': '03_pc', 'template_segment': 'Not mapped in template flow segment'},
 {'symbol_name': 'REJECTED_COLUMN_BUSINESS_CONTEXT_FROM_WIDGET', 'module': 'business_context', 'kind': 'constant', 'workflow_step': '9', 'role': 'optional', 'summary_override': 'Rejected business context rows captured during review.', 'template_notebook': '03_pc', 'template_segment': 'Not mapped in template flow segment'},
 {'symbol_name': 'prepare_business_context_profile_input', 'module': 'business_context', 'kind': 'function', 'workflow_step': '9', 'role': 'optional', 'summary_override': None, 'template_notebook': '03_pc', 'template_segment': 'Not mapped in template flow segment'},
 {'symbol_name': 'suggest_column_business_contexts', 'module': 'business_context', 'kind': 'function', 'workflow_step': '9', 'role': 'optional', 'summary_override': None, 'template_notebook': '03_pc', 'template_segment': 'Not mapped in template flow segment'},
 {'symbol_name': 'extract_column_business_context_suggestions', 'module': 'business_context', 'kind': 'function', 'workflow_step': '9', 'role': 'optional', 'summary_override': None, 'template_notebook': '03_pc', 'template_segment': 'Not mapped in template flow segment'},
 {'symbol_name': 'capture_column_business_context', 'module': 'business_context', 'kind': 'function', 'workflow_step': '9', 'role': 'optional', 'summary_override': None, 'template_notebook': '03_pc', 'template_segment': 'Not mapped in template flow segment'},
 {'symbol_name': 'build_metadata_table_key', 'module': 'metadata', 'kind': 'function', 'workflow_step': '10', 'role': 'optional', 'summary_override': None, 'template_notebook': '03_pc', 'template_segment': 'Not mapped in template flow segment'},
 {'symbol_name': 'build_metadata_column_key', 'module': 'metadata', 'kind': 'function', 'workflow_step': '10', 'role': 'optional', 'summary_override': None, 'template_notebook': '03_pc', 'template_segment': 'Not mapped in template flow segment'},
 {'symbol_name': 'build_dq_rule_key', 'module': 'metadata', 'kind': 'function', 'workflow_step': '10', 'role': 'optional', 'summary_override': None, 'template_notebook': '03_pc', 'template_segment': 'Not mapped in template flow segment'},
 {'symbol_name': 'write_metadata_rows', 'module': 'metadata', 'kind': 'function', 'workflow_step': '10', 'role': 'optional', 'summary_override': None, 'template_notebook': '03_pc', 'template_segment': 'Not mapped in template flow segment'},
 {'symbol_name': 'write_column_business_context', 'module': 'metadata', 'kind': 'function', 'workflow_step': '10', 'role': 'optional', 'summary_override': None, 'template_notebook': '03_pc', 'template_segment': 'Not mapped in template flow segment'},
 {'symbol_name': 'write_column_governance_context', 'module': 'metadata', 'kind': 'function', 'workflow_step': '10', 'role': 'optional', 'summary_override': None, 'template_notebook': '03_pc', 'template_segment': 'Not mapped in template flow segment'}]
