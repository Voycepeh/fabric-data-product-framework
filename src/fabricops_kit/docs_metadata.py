...
PUBLIC_SYMBOL_DOCS: list[PublicSymbolDocMetadata] = [
    ...
    {"symbol_name": "bootstrap_fabric_env", "module": "config", "kind": "function", "workflow_step": 2, "summary_override": None},
    {"symbol_name": "run_config_smoke_tests", "module": "config", "kind": "function", "workflow_step": 2, "summary_override": None},
    ...
    {"symbol_name": "bootstrap_fabric_env", "module": "config", "kind": "function", "workflow_step": 2, "summary_override": "One-line environment bootstrap for Fabric runtime readiness."},
    {"symbol_name": "run_config_smoke_tests", "module": "config", "kind": "function", "workflow_step": 2, "summary_override": "Smoke-test orchestrator for config readiness checks."},
    {"symbol_name": "check_fabric_ai_functions_available", "module": "config", "kind": "function", "workflow_step": 2, "summary_override": "Fabric AI readiness check for notebook runtime availability."},
    {"symbol_name": "get_path", "module": "config", "kind": "function", "workflow_step": 2, "summary_override": "Environment/target path resolver for configured Fabric routes."},
